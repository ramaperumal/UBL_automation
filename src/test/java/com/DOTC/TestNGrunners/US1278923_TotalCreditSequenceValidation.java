...
@CucumberOptions(
		 features = "src/test/resources/features/US1278923_TotalCreditSequenceValidation.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1278923_TotalCreditSequenceValidation extends AbstractTestNGCucumberTests {
