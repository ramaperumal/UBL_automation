...
@CucumberOptions(
		 features = "src/test/resources/features/US1280191_Search_OpenTimeList.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1280191_Search_OpenTimeList extends AbstractTestNGCucumberTests {
