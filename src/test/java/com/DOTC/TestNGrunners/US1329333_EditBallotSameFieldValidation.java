...
@CucumberOptions(
		 features = "src/test/resources/features/US1329333_EditBallotSameFieldValidation.feature", glue = { "com.DOTC.stepDefinitions" },// tags= {"@US1329333SC1"},
...
public class US1329333_EditBallotSameFieldValidation extends AbstractTestNGCucumberTests {
