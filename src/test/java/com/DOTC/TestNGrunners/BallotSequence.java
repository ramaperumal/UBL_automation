...
@CucumberOptions(
		 features = "src/test/resources/features/BallotSequence.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class BallotSequence extends AbstractTestNGCucumberTests {
