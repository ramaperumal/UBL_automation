...
@CucumberOptions(
		 features = "src/test/resources/features/US1275092_InclusiveTimeframeValidation.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1275092_InclusiveTimeframeValidation extends AbstractTestNGCucumberTests {
