...
@CucumberOptions(
		 features = "src/test/resources/features/US1345583_SaveBallotWithLayover.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1345583_SaveBallotWithLayover extends AbstractTestNGCucumberTests {
