...
@CucumberOptions(
		 features = "src/test/resources/features/calendar_activity.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class Calendar_activity extends AbstractTestNGCucumberTests {
