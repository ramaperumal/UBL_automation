...
@CucumberOptions(
		 features = "src/test/resources/features/US1329335_Delete_Ballots.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1329335_Delete_Ballots extends AbstractTestNGCucumberTests {
