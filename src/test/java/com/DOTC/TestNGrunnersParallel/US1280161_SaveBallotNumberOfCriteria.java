...
@CucumberOptions(
		 features = "src/test/resources/features/US1280161_SaveBallotNumberOfCriteria.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1280161_SaveBallotNumberOfCriteria extends AbstractTestNGCucumberTests {
