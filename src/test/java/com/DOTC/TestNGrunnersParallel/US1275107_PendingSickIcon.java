...
@CucumberOptions(
		 features = "src/test/resources/features/US1275107_PendingSickIcon.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1275107_PendingSickIcon extends AbstractTestNGCucumberTests {
