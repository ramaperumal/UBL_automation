...
@CucumberOptions(
		 features = "src/test/resources/features/US1272281_emulate.feature", glue = { "com.DOTC.stepDefinitions" },
...
public class US1272281_emulate extends AbstractTestNGCucumberTests {
