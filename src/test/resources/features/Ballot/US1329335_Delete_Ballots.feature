Feature: US1329335 Ballot Feature
  As a PilotDOTC user, i should be able to check the ballots are deleted from the ballots list

 @Ballot @Smoke @SCH @US1329335 @DeleteBallot @Medium @AA
  Scenario Outline: Validate delete Ballots. Test Case Name:US1329335 Ballots_screen delete All Ballots. Priority: Useful. Risk: Medium.
    ...
    Examples: 
      ...
      | DFW  | PickUpDOTC  | PickUpOutside | Template    | Test_US1329335 |
